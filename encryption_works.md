...
* Each person should create a new pseudonymous Jabber account. One way to do this is to go to [https://register.jabber.org/](https://register.jabber.org/) in the Tails browser. Since Tails makes all Internet traffic go over Tor, this is effectively making an anonymous Jabber account.
